<template lang="pug">
    section.todo-item
        ...
        button(class="btn btn-danger btn-sm todo-item__delete" type="button" v-on:click="deleteTodo(todo.id)") Delete
        button(class="todo-item__delete__small" type="button" v-on:click="deleteTodo(todo.id)")
